  ...
  return db.$transaction(async (tx) => {
    ...
    const doc = await tx.documentoComercial.create({
      data: {
        ...
        cae: input.cae || null, caeVencimiento: input.caeVencimiento ? new Date(input.caeVencimiento) : null, codigoAutorizacion: input.codigoAutorizacion || null, qrPayload: input.qrPayload || null, idempotencyKey: input.idempotencyKey || null,
        ...totales,
