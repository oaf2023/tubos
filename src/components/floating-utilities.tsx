...
import {
  ...
  ArrowLeftRight, CheckSquare, FolderOpen, CloudSun, Barcode, X,
} from 'lucide-react'
import {
...
const MENU_ITEMS = [
  ...
  { id: 'impresion-cb', icon: Barcode, label: 'Impresión CB', color: 'bg-teal-50 hover:bg-teal-100 text-teal-700' },
] as const
